...
import aiss.grupo6.youtubeMiner.model.Channel;
...
public class VMChannel {
    ...
    public static VMChannel of(Channel c) {
        SnippetMain sm = c.getSnippetMain();
        return of(c.getId(), sm.getTitle(), sm.getDescription(), sm.getPublishedAt(), new ArrayList<>());
    }
